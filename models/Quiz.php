...
class Quiz
{
    ...
    {
        $sql = 'SELECT qs.id as question_id, q.title as quiz_title, q.description, qs.title, qs.points, qs.is_audio, an.is_text, an.content, an.id as answer_id, an.is_text
         FROM quizes as q 
